...
# ---------- Device Database (For Dynamic Device Spoofing) ----------
DEVICES = [
...
def perform_major_login(access_token, open_id):
    ...
    for platform_type in platforms:
        try:
            ...
            game_data.version_code = "1.121.0"  # OB54
            ...
            headers["User-Agent"] = f"Dalvik/2.1.0 (Linux; U; Android {device['android']}; {device['model']} Build/{device['build']})"
